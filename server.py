...
SSL_CERT_FILE = os.environ.get("GALLERY_SSL_CERT", os.path.join(CERT_DIR, "<hostname>.local+1.pem"))
SSL_KEY_FILE = os.environ.get("GALLERY_SSL_KEY", os.path.join(CERT_DIR, "<hostname>.local+1-key.pem"))
